...
<!--/Pre Loader -->
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="fuliNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="福利名称" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        福利类型
                                        <div class="layui-input-inline">
                                            <select name="fuliTypesSelectSearch"  style="width: 150px;" id="fuliTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if( fuliNameSearchInput != null){
                ...
                //福利类型
            var fuliTypesSelectSearchInput = document.getElementById("fuliTypesSelectSearch");
            if(fuliTypesSelectSearchInput != null){
                var fuliTypesIndex = fuliTypesSelectSearchInput.selectedIndex;
                if( fuliTypesIndex  != 0){
                    searchForm.fuliTypes= document.getElementById("fuliTypesSelectSearch").options[fuliTypesIndex].value;
                }
            }
                            getDataList();
        }
        ...
        function getDataList() {
            http("fuli/page", "GET", {
                ...
                fuliTypes: searchForm.fuliTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //福利类型
            var fuliTypesCell = document.createElement('td');
            fuliTypesCell.innerHTML = item.fuliValue;
            row.appendChild(fuliTypesCell);
            ...
            //发放时间
            var fuliTimeCell = document.createElement('td');
            fuliTimeCell.innerHTML = item.fuliTime;
            row.appendChild(fuliTimeCell);
    ...
    //填充本表搜索下拉框
        ...
        function fuliTypesSelectSearch() {
            var fuliTypesSelectSearch = document.getElementById('fuliTypesSelectSearch');
            if(fuliTypesSelectSearch != null) {
                fuliTypesSelectSearch.add(new Option('-请选择-',''));
                if (fuliTypesOptions != null && fuliTypesOptions.length > 0){
                    for (var i = 0; i < fuliTypesOptions.length; i++) {
                            fuliTypesSelectSearch.add(new Option(fuliTypesOptions[i].indexName,fuliTypesOptions[i].codeIndex));
                    }
                }
            }
        }
    ...
    //查询当前表搜索条件所有列表
            function fuliTypesSelect() {
                //填充下拉框选项
                http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=fuli_types", "GET", {}, (res) => {
                    if(res.code == 0){
                        fuliTypesOptions = res.data.list;
                    }
                });
            }
