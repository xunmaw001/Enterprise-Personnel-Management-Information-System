...
<!--/Pre Loader -->
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="jinagchengNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        奖惩类型
                                        <div class="layui-input-inline">
                                            <select name="jinagchengTypesSelectSearch"  style="width: 150px;" id="jinagchengTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //奖惩名称
            var jinagchengNameSearchInput = $('#jinagchengNameSearch');
            if( jinagchengNameSearchInput != null){
                if (jinagchengNameSearchInput.val() != null && jinagchengNameSearchInput.val() != '') {
                    searchForm.jinagchengName = $('#jinagchengNameSearch').val();
                }
            }
     
                //奖惩类型
            var jinagchengTypesSelectSearchInput = document.getElementById("jinagchengTypesSelectSearch");
            if(jinagchengTypesSelectSearchInput != null){
                var jinagchengTypesIndex = jinagchengTypesSelectSearchInput.selectedIndex;
                if( jinagchengTypesIndex  != 0){
                    searchForm.jinagchengTypes= document.getElementById("jinagchengTypesSelectSearch").options[jinagchengTypesIndex].value;
                }
            }
                        getDataList();
        }
        ...
        function getDataList() {
            http("jinagcheng/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                //本表的
                jinagchengName: searchForm.jinagchengName,
                jinagchengTypes: searchForm.jinagchengTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //奖惩名称
            var jinagchengNameCell = document.createElement('td');
            jinagchengNameCell.innerHTML = item.jinagchengName;
            row.appendChild(jinagchengNameCell);


            //奖惩类型
            var jinagchengTypesCell = document.createElement('td');
            jinagchengTypesCell.innerHTML = item.jinagchengValue;
            row.appendChild(jinagchengTypesCell);


                //奖惩详情
            var jinagchengContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.jinagchengContent && item.jinagchengContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.jinagchengContent.indexOf('<img');
                var endIndex = item.jinagchengContent.indexOf('>');
                    jinagchengContentCell.innerHTML = item.jinagchengContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.jinagchengContent != null && item.jinagchengContent != "" && item.jinagchengContent.length >= 11) {
                        jinagchengContentCell.innerHTML = item.jinagchengContent.substring(0, 10) + "...";
                } else {
                        jinagchengContentCell.innerHTML = item.jinagchengContent;
                }
            }
            row.appendChild(jinagchengContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("jinagcheng/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addjinagcheng", "addjinagcheng");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function jinagchengTypesSelectSearch() {
            var jinagchengTypesSelectSearch = document.getElementById('jinagchengTypesSelectSearch');
            if(jinagchengTypesSelectSearch != null) {
                jinagchengTypesSelectSearch.add(new Option('-请选择-',''));
                if (jinagchengTypesOptions != null && jinagchengTypesOptions.length > 0){
                    for (var i = 0; i < jinagchengTypesOptions.length; i++) {
                            jinagchengTypesSelectSearch.add(new Option(jinagchengTypesOptions[i].indexName,jinagchengTypesOptions[i].codeIndex));
                    }
                }
            }
        }
    ...
    //查询当前表搜索条件所有列表
            function jinagchengTypesSelect() {
                //填充下拉框选项
                http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=jinagcheng_types", "GET", {}, (res) => {
                    if(res.code == 0){
                        jinagchengTypesOptions = res.data.list;
                    }
                });
            }
