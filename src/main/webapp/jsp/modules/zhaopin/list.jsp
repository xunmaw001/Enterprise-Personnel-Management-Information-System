...
<!--/Pre Loader -->
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="zhaopinNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="招聘名称" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        招聘人数
                                        <div class="layui-input-inline">
                                            <input type="text" id="zhaopinNumberStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="zhaopinNumberChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="zhaopinNumberEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="zhaopinNumberChickValue(this)"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        工作地址
                                        <div class="layui-input-inline">
                                            <input type="text" id="gongzuoAddressSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="工作地址" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <!-- 本表的查询条件 -->
            ...
            if(zhaopinTypesSelectSearchInput != null){
                ...
                //招聘人数
            var zhaopinNumberStartSearchInput = $('#zhaopinNumberStartSearch');
            if(zhaopinNumberStartSearchInput != null){
                var zhaopinNumberStartSearchValue = zhaopinNumberStartSearchInput.val();
                if( zhaopinNumberStartSearchValue  != 0){
                    searchForm.zhaopinNumberStart = zhaopinNumberStartSearchValue;
                }
            }
            var zhaopinNumberEndSearchInput = $('#zhaopinNumberEndSearch');
            if(zhaopinNumberEndSearchInput != null){
                var zhaopinNumberEndSearchValue = zhaopinNumberEndSearchInput.val();
                if( zhaopinNumberEndSearchValue  != 0){
                    searchForm.zhaopinNumberEnd = zhaopinNumberEndSearchValue;
                }
            }
     
            //工作地址
            var gongzuoAddressSearchInput = $('#gongzuoAddressSearch');
            if( gongzuoAddressSearchInput != null){
                if (gongzuoAddressSearchInput.val() != null && gongzuoAddressSearchInput.val() != '') {
                    searchForm.gongzuoAddress = $('#gongzuoAddressSearch').val();
                }
            }
                        getDataList();
        }
        ...
        function getDataList() {
            http("zhaopin/page", "GET", {
                ...
                zhaopinNumberStart: searchForm.zhaopinNumberStart,
                zhaopinNumberEnd: searchForm.zhaopinNumberEnd,
                gongzuoAddress: searchForm.gongzuoAddress,
            //级联表的
