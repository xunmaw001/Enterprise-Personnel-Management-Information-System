                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="peixunName" name="peixunName" class="form-control"
                                               v-model="ruleForm.peixunName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>培训类型</label>
                                    <input id="peixunValue" name="peixunValue" class="form-control"
                                           v-model="ruleForm.peixunValue" readonly>
                                </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.peixunContent != null && ruleForm.peixunContent != 'null' && ruleForm.peixunContent != '') {
            var peixunContentUeditor = UE.getEditor('peixunContentEditor');
                peixunContentUeditor.ready(function () {
                    var mes = '' + ruleForm.peixunContent;
                    peixunContentUeditor.setContent(mes);
                    peixunContentUeditor.setDisabled('fullscreen');
            });
        }
    }
