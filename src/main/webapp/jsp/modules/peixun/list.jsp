...
<!--/Pre Loader -->
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="peixunNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="培训名称" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        培训类型
                                        <div class="layui-input-inline">
                                            <select name="peixunTypesSelectSearch"  style="width: 150px;" id="peixunTypesSelectSearch" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        培训开始时间
                                        <div class="layui-input-inline">
                                            <input type="datetime-local" id="onTimeStartSearch" style="width: 190px;" class="form-control form-control-sm"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="datetime-local" id="onTimeEndSearch" style="width: 190px;" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        培训结束时间
                                        <div class="layui-input-inline">
                                            <input type="datetime-local" id="downTimeStartSearch" style="width: 190px;" class="form-control form-control-sm"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="datetime-local" id="downTimeEndSearch" style="width: 190px;" class="form-control form-control-sm"
                                                   placeholder="结束" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //培训名称
            var peixunNameSearchInput = $('#peixunNameSearch');
            if( peixunNameSearchInput != null){
                if (peixunNameSearchInput.val() != null && peixunNameSearchInput.val() != '') {
                    searchForm.peixunName = $('#peixunNameSearch').val();
                }
            }
     
                //培训类型
            var peixunTypesSelectSearchInput = document.getElementById("peixunTypesSelectSearch");
            if(peixunTypesSelectSearchInput != null){
                var peixunTypesIndex = peixunTypesSelectSearchInput.selectedIndex;
                if( peixunTypesIndex  != 0){
                    searchForm.peixunTypes= document.getElementById("peixunTypesSelectSearch").options[peixunTypesIndex].value;
                }
            }
        ...
        function getDataList() {
            http("peixun/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                //本表的
                peixunName: searchForm.peixunName,
                peixunTypes: searchForm.peixunTypes,
        ...
        function setDataRow(item, number) {
            ...
            //培训名称
            var peixunNameCell = document.createElement('td');
            peixunNameCell.innerHTML = item.peixunName;
            row.appendChild(peixunNameCell);


            //培训类型
            var peixunTypesCell = document.createElement('td');
            peixunTypesCell.innerHTML = item.peixunValue;
            row.appendChild(peixunTypesCell);
            ...
            row.appendChild(downTimeCell);
                ...
                //培训内容
            var peixunContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.peixunContent && item.peixunContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.peixunContent.indexOf('<img');
                var endIndex = item.peixunContent.indexOf('>');
                    peixunContentCell.innerHTML = item.peixunContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.peixunContent != null && item.peixunContent != "" && item.peixunContent.length >= 11) {
                        peixunContentCell.innerHTML = item.peixunContent.substring(0, 10) + "...";
                } else {
                        peixunContentCell.innerHTML = item.peixunContent;
                }
            }
            row.appendChild(peixunContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("peixun/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addpeixun", "addpeixun");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function peixunTypesSelectSearch() {
            var peixunTypesSelectSearch = document.getElementById('peixunTypesSelectSearch');
            if(peixunTypesSelectSearch != null) {
                peixunTypesSelectSearch.add(new Option('-请选择-',''));
                if (peixunTypesOptions != null && peixunTypesOptions.length > 0){
                    for (var i = 0; i < peixunTypesOptions.length; i++) {
                            peixunTypesSelectSearch.add(new Option(peixunTypesOptions[i].indexName,peixunTypesOptions[i].codeIndex));
                    }
                }
            }
        }
