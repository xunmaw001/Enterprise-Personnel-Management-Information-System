...
public class JinagchengView extends JinagchengEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		/**
		* 奖惩类型的值
		*/
		private String jinagchengValue;
	...
	public JinagchengView() {

	}

	public JinagchengView(JinagchengEntity jinagchengEntity) {
		try {
			BeanUtils.copyProperties(this, jinagchengEntity);
			...
			* 获取： 奖惩类型的值
			*/
			public String getJinagchengValue() {
				return jinagchengValue;
			}
			/**
			* 设置： 奖惩类型的值
			*/
			public void setJinagchengValue(String jinagchengValue) {
				this.jinagchengValue = jinagchengValue;
			}
